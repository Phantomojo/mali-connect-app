    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loanProducts.map((loan) => (
              <div key={loan.id} className="bg-white rounded-2xl shadow-xl p-6">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">{loan.name}</h3>
                ...
                <button className="w-full py-3 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
      ...
      {activeTab === 'calculator' && (
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h3 className="text-xl font-bold text-gray-800 mb-6">Loan Calculator</h3>
              ...
              {selectedAnimal && (
                <div className="p-4 bg-green-50 rounded-lg">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-medium text-green-800">Mali-Score Bonus</span>
                  </div>
